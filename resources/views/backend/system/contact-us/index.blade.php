                            ...
                            <table class="datatables table dataTable no-footer dtr-column" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                ...
                                @foreach ($thisDatas as $thisDatasKey => $thisDatasDatum)
                                    <tr>
                                        ...
                                        <td>{{ $thisDatasDatum->message }}</td>
                                        <td>{{ $thisDatasDatum->phone }}</td>
                                        <td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        @if(hasPermission('/'.strtolower($title).'/*','put'))
                                                            <a class="dropdown-item" href="{{ route('contacts.edit', $thisDatasDatum->id) }}"><i class="ti ti-pencil me-1"></i>{{ __('Edit') }}</a>
                                                        @endif
                                                        @if(hasPermission('/'.strtolower($title).'/*','delete'))
                                                            <a href="#" class="dropdown-item delete-button" data-bs-toggle="modal" data-actionurl="{{ route('contacts.destroy', $thisDatasDatum->id) }}" data-bs-target="#deleteModal">
