                ...
                <div class="card-datatable table-responsive">
                    <form method="get" action="{{ route('campaigns.index') }}">
                        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap">
                                            <div class="btn-group">
                                                ...
                                                @if(hasPermission('/'.strtolower($title).'/*','put'))
                                                    <a class="btn add-new btn-primary text-white" href="{{ route('campaigns.create') }}">
                            ...
                            <table class="datatables-campaigns table dataTable no-footer dtr-column" id="DataTables_Table_0">
                                ...
                                @endif
                                @foreach ($thisDatas as $index => $campaign)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        @if(hasPermission('/'.strtolower($title).'/*','delete'))
                                                            <a href="#" class="dropdown-item delete-button" data-bs-toggle="modal" data-actionurl="{{ route('campaigns.destroy', $campaign->id) }}" data-bs-target="#deleteModal">
