...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" action="{{ route('campaigns.store') }}" method="post"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 d-none">
                        ...
                        <input required value="{{ old('slug') }}" type="text" name="slug" id="slug"
                        ...
                        <select required name="campaign_category_id" id="campaign_category_id"
                            ...
                            @foreach($campaignCategories as $category)
                                <option value="{{ $category->id }}"
                                        @if(old('campaign_category_id') == $category->id) selected @endif>
                                    {{ $category->title }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input required type="date" name="start_date" id="start_date" value="{{ old('start_date') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <input required type="date" name="end_date" id="end_date" value="{{ old('end_date') }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check-inline">
                            <input type="radio" id="feature1" name="is_featured" value="1" checked
                        ...
                        <div class="form-check-inline">
                            <input type="radio" id="feature2" name="is_featured" value="0"
                                   class="form-check-input @if ($errors->first('is_featured')) is-invalid @endif"
                                   @if(old('is_featured') == '0') checked @endif>
