...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" action="{{ route('payment-gateways.store') }}" method="post"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select required class="form-control @error('payment_gateway') is-invalid @enderror"
                            ...
                            <option value="bank"
                                    @if(old('payment_gateway') == 'bank') selected @endif>{{ __('Bank') }}</option>
                            <option value="esewa"
                                    @if(old('payment_gateway') == 'esewa') selected @endif>{{ __('Esewa') }}</option>
                            <option value="khalti"
                                    @if(old('payment_gateway') == 'khalti') selected @endif>{{ __('Khalti') }}</option>
                        </select>
                    ...
                    <div class="col-md-6 bank-details">
                        ...
                        <input required type="text" name="bank_name" id="bank_name" value="{{ old('bank_name') }}"
