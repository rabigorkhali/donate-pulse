                                        ...
                                        <div class="dt-buttons btn-group flex-wrap">
                                            <div class="btn-group">
                                                ...
                                                @if(hasPermission('/payment-gateways/*', 'put'))
                                                    <a class="btn add-new btn-primary text-white" href="{{ route('payment-gateways.create') }}">
                                            ...
                                            @if(hasPermission('/payment-gateways/*', 'put') || hasPermission('/payment-gateways/*', 'delete'))
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        @if(hasPermission('/payment-gateways/*', 'put'))
                                                            <a class="dropdown-item" href="{{ route('payment-gateways.edit', $payment->id) }}">
                                                                <i class="ti ti-pencil me-1"></i>{{ __('Edit') }}
                                                            </a>
                                                        @endif
                                                        @if(hasPermission('/payment-gateways/*', 'delete'))
                                                            <a href="#" class="dropdown-item delete-button" data-bs-toggle="modal" data-actionurl="{{ route('payment-gateways.destroy', $payment->id) }}" data-bs-target="#deleteModal">
