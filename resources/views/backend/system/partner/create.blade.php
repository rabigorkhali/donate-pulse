            ...
            <form class="card-body" action="{{ route('partners.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ old('website') }}" type="url" name="website" id="website"
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Partner Description">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <input required value="{{ old('position') }}" type="number" name="position" id="position"
