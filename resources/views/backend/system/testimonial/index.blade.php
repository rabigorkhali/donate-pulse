                    ...
                    <form method="get" action="{{ route('testimonials.index') }}">
                        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                            ...
                            <table class="datatables-teams table dataTable no-footer dtr-column" id="DataTables_Table_0">
                                ...
                                @endif
                                @foreach ($thisDatas as $index => $testimonial)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        ...
                                        <td>
                                            @if($testimonial->image)
                                                <img src="{{ asset($testimonial->image) }}" width="50" alt="Image" class="img-fluid">
                                            @else
                                                N/A
                                            @endif
                                        </td>
                                        <td><span class="badge @if ($testimonial->status) bg-label-primary @else bg-label-secondary @endif me-1">
