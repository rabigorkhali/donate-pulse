...
class Service
{
    ...
    public function store($request)
    {
        ...
        if ($request->file('image')) {
            $data['image'] = $this->fullImageUploadPath . uploadImage($this->fullImageUploadPath, 'image', false, 300, null);
        }

        if ($request->file('cover_image')) {
            $data['cover_image'] = $this->fullImageUploadPath . uploadImage($this->fullImageUploadPath, 'cover_image', false, 300, null);
        }

        if ($request->file('logo')) {
            $data['logo'] = $this->fullImageUploadPath . uploadImage($this->fullImageUploadPath, 'logo', false, 300, null);
        }

        if ($request->file('banner')) {
            $data['banner'] = $this->fullImageUploadPath . uploadImage($this->fullImageUploadPath, 'banner', false, 1024, null);
        }

        if ($request->file('thumbnail_image')) {
            $data['thumbnail_image'] = $this->fullImageUploadPath . uploadImage($this->fullImageUploadPath, 'thumbnail_image', false, 300, null);
        }
